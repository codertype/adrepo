...
import { validateCriticalEnvironmentVariables, printEnvironmentReport } from "./envValidation";

const app = express();

// Trust proxy for HTTPS and proper header handling behind Nginx reverse proxy
